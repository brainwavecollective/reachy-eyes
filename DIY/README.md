...
| File | What it covers |
|------|---------------|
| [Electronics.md](./Electronics.md) | Component sourcing, BOM, DigiKey cart, and part-by-part notes |
| [3D.md](./3D.md) | Print settings, orientation, and material notes for the enclosure parts |
| [Assembly.md](./Assembly.md) | Putting it all together, wiring, and firmware setup |
...
Once you have everything in hand, this guide walks through the physical build and getting the firmware running.
