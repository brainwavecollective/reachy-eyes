## Modified Installation Steps for Option B AKA "Pinpoint Eyes"

The default eyes are likely great for most users. However, if you would like to modify the look of your eye to be more like the factory at rest, and produce a small, crisp, pinpoint of light, then you may want to consider Option B.

### Aditional tools neccessary 
 - Two strong gripping tools (pliers, vice, etc.)
 - Eye protection
 - Tweezers
 
## Choosing different eye options 
Speaking franly, I think most people will be very happy with Option A. However, if you want exceptionally crisp eyes, and you don't mind some extra steps, then you may want to consider Option B.
